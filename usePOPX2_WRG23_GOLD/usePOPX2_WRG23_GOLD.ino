...
void manualCalibrate() {
  qtra.calibrate();
  qtra.calibratedMaximumOn[0] = 983;
  qtra.calibratedMinimumOn[0] = 752;  //
  qtra.calibratedMaximumOn[1] = 987;
  qtra.calibratedMinimumOn[1] = 353;  //
  qtra.calibratedMaximumOn[2] = 983;
  qtra.calibratedMinimumOn[2] = 212;  //
  qtra.calibratedMaximumOn[3] = 987;
  qtra.calibratedMinimumOn[3] = 166;  //
}
